...
const char* password = "F5[Kjv-cpc"; // Replace with your network password
#define DATABASE_URL "https://lab-5-power-management-cf4dd-default-rtdb.firebaseio.com" // Replace with your database URL
#define API_KEY "AIzaSyCqrTkl9OUOP2BeCm0Z_qjls0V3v8GySds" // Replace with your API key
